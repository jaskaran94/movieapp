...
public class DetailFragment extends Fragment {
    ...
    * */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(arguments != null || intent != null && intent.hasExtra("movies_details")){
            ...
            rootView = mLayoutInflater.inflate(R.layout.fragment_placeholder,
                    container, false);
        }
    ...
    * */
    private void addToFavorites() {
        ...
        values.put(PopularMovieContract.MovieEntry.MOVIE_ID, movie.getId());
        ...
        values.put(PopularMovieContract.MovieEntry.MOVIE_TRAILERS, movie.getMovieTrailers());
    ...
    * */
    private boolean checkFavorites() {
        ...
        Uri uri = PopularMovieContract.MovieEntry.buildMovieUri(movie.getId());
        ContentResolver resolver = getActivity().getContentResolver();
        Cursor cursor = null;
    ...
    * */
    private void parseTrailers(){
        ...
        try{
            ...
            JSONObject trailersJson = new JSONObject(movie.getMovieTrailers());
